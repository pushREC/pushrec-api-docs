---
source: https://docs.digitalocean.com/reference/api/scopes/domain/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/domain/
domain: docs.digitalocean.com
---
                domain | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [domain](/reference/api/scopes/domain/)
            *   [domain:create](/reference/api/scopes/domain/create/)
            *   [domain:delete](/reference/api/scopes/domain/delete/)
            *   [domain:read](/reference/api/scopes/domain/read/)
            *   [domain:update](/reference/api/scopes/domain/update/)
...
[](/reference/api/scopes/domain/create/)
...
[](/reference/api/scopes/domain/delete/)
...
[](/reference/api/scopes/domain/read/)
...
[](/reference/api/scopes/domain/update/)
