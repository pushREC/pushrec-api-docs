---
source: https://docs.digitalocean.com/reference/api/scopes/database/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/database/
domain: docs.digitalocean.com
---
                database | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [database](/reference/api/scopes/database/)
            *   [database:create](/reference/api/scopes/database/create/)
            *   [database:delete](/reference/api/scopes/database/delete/)
            *   [database:read](/reference/api/scopes/database/read/)
            *   [database:update](/reference/api/scopes/database/update/)
            *   [database:view\_credentials](/reference/api/scopes/database/view_credentials/)
...
[](/reference/api/scopes/database/create/)
...
[](/reference/api/scopes/database/delete/)
...
[](/reference/api/scopes/database/read/)
...
[](/reference/api/scopes/database/update/)
...
[](/reference/api/scopes/database/view_credentials/)
