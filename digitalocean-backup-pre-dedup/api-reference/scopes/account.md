---
source: https://docs.digitalocean.com/reference/api/scopes/account/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/account/
domain: docs.digitalocean.com
---
                account | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        *   [account](/reference/api/scopes/account/)
            *   [account:read](/reference/api/scopes/account/read/)
...
[](/reference/api/scopes/account/read/)
