---
source: https://docs.digitalocean.com/reference/api/scopes/block_storage_snapshot/create/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/block_storage_snapshot/create/
domain: docs.digitalocean.com
---
                block\_storage\_snapshot:create | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [block\_storage\_snapshot](/reference/api/scopes/block_storage_snapshot/)
            *   [block\_storage\_snapshot:create](/reference/api/scopes/block_storage_snapshot/create/)
            *   [block\_storage\_snapshot:delete](/reference/api/scopes/block_storage_snapshot/delete/)
            *   [block\_storage\_snapshot:read](/reference/api/scopes/block_storage_snapshot/read/)
