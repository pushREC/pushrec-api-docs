---
source: https://docs.digitalocean.com/products/databases/opensearch/getting-started/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               Getting Started with OpenSearch | DigitalOcean Documentation
...
Validated on 17 Jun 2024 • Last edited on 17 Apr 2025

OpenSearch is an open-source search and analytics suite which serves as a centralized location to manage logs forwarded from other resources, such as databases and Droplets.

[](/products/databases/opensearch/getting-started/quickstart/)
...
[Getting Started with OpenSearch](https://docs.digitalocean.com/products/databases/opensearch/getting-started/)
