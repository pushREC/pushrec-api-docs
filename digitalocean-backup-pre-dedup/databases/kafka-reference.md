---
source: https://docs.digitalocean.com/products/databases/kafka/reference/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               Kafka Reference | DigitalOcean Documentation
...
Validated on 4 Jul 2021 • Last edited on 5 Dec 2025
...
You can use the API to [manage clusters, Topics, and users](/reference/api/digitalocean/#tag/Databases).
...
## Official Kafka Documentation[](#official-kafka-documentation)
