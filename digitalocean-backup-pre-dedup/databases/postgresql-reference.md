---
source: https://docs.digitalocean.com/products/databases/postgresql/reference/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               PostgreSQL Reference | DigitalOcean Documentation
...
Validated on 2 Aug 2019 • Last edited on 11 Dec 2025
...
See the [API documentation on databases](/reference/api/digitalocean/#tag/Databases) for more information.
...
## Official PostgreSQL Documentation[](#official-postgresql-documentation)
