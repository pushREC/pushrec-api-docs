---
source: https://docs.digitalocean.com/products/databases/mongodb/getting-started/quickstart/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               MongoDB Quickstart | DigitalOcean Documentation
...
## Create MongoDB Database Clusters[](#create-mongodb-database-clusters)
