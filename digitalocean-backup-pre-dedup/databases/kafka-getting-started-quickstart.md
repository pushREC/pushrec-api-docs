---
source: https://docs.digitalocean.com/products/databases/kafka/getting-started/quickstart/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               Kafka Quickstart | DigitalOcean Documentation
...
## Create Kafka Clusters[](#create-kafka-clusters)
