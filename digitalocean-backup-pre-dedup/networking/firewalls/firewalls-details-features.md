---
source: '[unknown - firewalls-details-features.md]'
scraped: 2026-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               Firewalls Features | DigitalOcean Documentation
...
You can apply cloud firewall rules to individual Droplets, but a more powerful option is to use [tags](/products/droplets/how-to/tag/). Tags are custom labels that you can apply to Droplets and other DigitalOcean resources. When you add a tag to a firewall, any Droplets with that tag are automatically included in the firewall configuration.

In this article...

[Firewalls Features](https://docs.digitalocean.com/products/networking/firewalls/details/features/)
