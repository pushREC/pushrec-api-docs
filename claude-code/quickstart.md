...
> **Tip:** After logging in (Step 2), your credentials are stored on your system. Learn more in [Credential Management](https://code.claude.com/docs/en/iam#credential-management).
...
- [Common workflows](https://code.claude.com/docs/en/common-workflows) - Step-by-step guides for common tasks
- [CLI reference](https://code.claude.com/docs/en/cli-reference) - Master all commands and options
- [Configuration](https://code.claude.com/docs/en/settings) - Customize Claude Code for your workflow
- [Claude Code on the web](https://code.claude.com/docs/en/claude-code-on-the-web) - Run tasks asynchronously in the cloud
- [About Claude Code](https://claude.com/product/claude-code) - Learn more on claude.com
