...
*   [Local Claude Code: Data flow and dependencies](#local-claude-code%3A-data-flow-and-dependencies)
*   [Cloud execution: Data flow and dependencies](#cloud-execution%3A-data-flow-and-dependencies)
...
Default on.  
`DISABLE_TELEMETRY=1` to disable.

Default off.  
`CLAUDE_CODE_USE_VERTEX` must be 1.
...
Default on.  
`DISABLE_ERROR_REPORTING=1` to disable.
...
**Claude API (`/bug` reports)**

Default on.  
`DISABLE_BUG_COMMAND=1` to disable.
...
[Privacy policy](https://www.anthropic.com/legal/privacy)[Disclosure policy](https://www.anthropic.com/responsible-disclosure-policy)[Usage policy](https://www.anthropic.com/legal/aup)[Commercial terms](https://www.anthropic.com/legal/commercial-terms)[Consumer terms](h
