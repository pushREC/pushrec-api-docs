...
duration_ms: 1719
---
lash commands - Claude Code Docs
...
Show token usage statistics. See [cost tracking guide](/docs/en/costs#using-the-cost-command) for subscription-specific details.
...
View or update [permissions](/docs/en/iam#configuring-permissions)
