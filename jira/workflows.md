...
# The Jira Cloud platform REST API - Workflows
...
|------|-----|------|----------|-------------|
| `workflowName` | query | string | No | The name of the workflow to be returned. Only one  |
...
curl -X GET \
  ...
  "https://your-domain.atlassian.net/rest/api/3/workflow"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflow/history"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflow/history/list"
```
...
| `workflowName` | query | array | No | The name of a workflow to return. To include multi |
| `expand` | query | string | No | Use [expand](#expansion) to include additional inf |
...
curl -X DELETE \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflow/{entityId}"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflow/{workflowId}/project/{projectId}/issueTypeUsages"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflow/{workflowId}/projectUsages"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflow/{workflowId}/workflowSchemes"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows/capabilities"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows/create/validation"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows/defaultEditor"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows/preview"
```
 ...
 *  `n |
| `scope` | query | string | No | The scope of the workflow. Global for company-mana |
| `isActive` | query | boolean | No | Filters active and inactive workflows. |
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows/search"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows/update"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/workflows/update/validation"
```
