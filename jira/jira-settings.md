---
created: 2026-01-09
tags: [type/api-reference, api/jira-settings]
api_name: The Jira Cloud platform REST API
category: Jira settings
endpoint_count: 4
---

# The Jira Cloud platform REST API - Jira Settings
...
| `permissionLevel` | query | string | No | The permission level of all items being returned i |
| `keyFilter` | query | string | No | When a `key` isn't provided, this filters the list |
...
curl -X GET \
  ...
  "https://your-domain.atlassian.net/rest/api/3/application-properties"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/application-properties/advanced-settings"
```
...
curl -X PUT \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/application-properties/{id}"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/configuration"
```
