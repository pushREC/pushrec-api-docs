---
created: 2026-01-09
tags: [type/api-reference, api/permission-schemes]
api_name: The Jira Cloud platform REST API
category: Permission schemes
endpoint_count: 9
---

# The Jira Cloud platform REST API - Permission Schemes
...
curl -X GET \
  ...
  "https://your-domain.atlassian.net/rest/api/3/permissionscheme"
```
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `schemeId` | path | integer | Yes | The ID of the permission scheme being deleted. |
...
curl -X DELETE \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/permissionscheme/{schemeId}"
```
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `schemeId` | path | integer | Yes | The ID of the permission scheme to return. |
| `expand` | query | string | No | Use expand to include additional information in th |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `schemeId` | path | integer | Yes | The ID of the permission scheme to update. |
| `expand` | query | string | No | Use expand to include additional information in th |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `schemeId` | path | integer | Yes | The ID of the permission scheme. |
| `expand` | query | string | No | Use expand to include additional information in th |
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/permissionscheme/{schemeId}/permission"
```
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `schemeId` | path | integer | Yes | The ID of the permission scheme in which to create |
| `expand` | query | string | No | Use expand to include additional information in th |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `schemeId` | path | integer | Yes | The ID of the permission scheme to delete the perm |
| `permissionId` | path | integer | Yes | The ID of the permission grant to delete. |
...
curl -X DELETE \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/permissionscheme/{schemeId}/permission/{permissionId}"
```
...
|------|-----|------|----------|-------------|
| `schemeId` | path | integer | Yes | The ID of the permission scheme. |
| `permissionId` | path | integer | Yes | The ID of the permission grant. |
| `expand` | query | string | No | Use expand to include additional information in th |
