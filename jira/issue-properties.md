---
created: 2026-01-09
tags: [type/api-reference, api/issue-properties]
api_name: The Jira Cloud platform REST API
category: Issue properties
endpoint_count: 8
---

# The Jira Cloud platform REST API - Issue Properties
...
curl -X POST \
  ...
  "https://your-domain.atlassian.net/rest/api/3/issue/properties"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/issue/properties/multi"
```
...
curl -X DELETE \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/issue/properties/{propertyKey}"
```
...
curl -X GET \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/issue/{issueIdOrKey}/properties"
```
...
curl -X DELETE \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/issue/{issueIdOrKey}/properties/{propertyKey}"
```
