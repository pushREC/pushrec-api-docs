---
created: 2026-01-09
tags: [type/api-reference, api/jira-expressions]
api_name: The Jira Cloud platform REST API
category: Jira expressions
endpoint_count: 3
---

# The Jira Cloud platform REST API - Jira Expressions
...
|------|-----|------|----------|-------------|
| `check` | query | string | No | The check to perform:

 *  `syntax` Each expressio |
...
curl -X POST \
  ...
  "https://your-domain.atlassian.net/rest/api/3/expression/analyse"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/expression/eval"
```
...
curl -X POST \
  -H "Authorization: Bearer $TOKEN" \
  "https://your-domain.atlassian.net/rest/api/3/expression/evaluate"
```
