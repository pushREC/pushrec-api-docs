---
source: https://docs.digitalocean.com/products/functions/details/
scraped: 2025-01-07
...
source_url: https://docs.digitalocean.com/products/functions/details/
domain: docs.digitalocean.com
---
                Functions Details | DigitalOcean Documentation
...
[](/products/functions/details/features/)

![](https://docs.digitalocean.com/images/icons/functions.svg)

Functions Features

Functions is a function as a service (FaaS) offering that lets you run your local serverless code in the cloud using Node.js, Python, Go, or PHP.

[](/products/functions/details/pricing/)

![](https://docs.digitalocean.com/images/icons/functions.svg)

Functions Pricing

Billing information for DigitalOcean Functions, including free allowance, bandwidth, and overage charges.

[](/products/functions/details/availability/)

![](https://docs.digitalocean.com/images/icons/functions.svg)

Functions Availability

Regional datacenter availability for DigitalOcean Functions.
...
[Functions Details](https://docs.digitalocean.com/products/functions/details/)
