---
source: https://docs.digitalocean.com/products/monitoring/reference/
scraped: 2025-01-07
tags: [digitalocean, containers, registry, functions, monitoring, api-docs]
---

tool: bright-data-skill
source_url: https://docs.digitalocean.com/products/monitoring/reference/
domain: docs.digitalocean.com
---
                Monitoring Reference | DigitalOcean Documentation
...
Validated on 22 Apr 2022 • Last edited on 11 Dec 2025
...
The [DigitalOcean MCP server](/reference/mcp/) lets you use natural language prompts to interact with DigitalOcean Insights features, including uptime checks, alert policies, and metrics across droplets, apps, and other resources.
...
MCP tools for managing DigitalOcean monitoring features.

In this article...

[Monitoring Reference](https://docs.digitalocean.com/products/monitoring/reference/)
