...
---
                How to Deploy Functions to App Platform | DigitalOcean Documentation
...
After deployment, you can also [set up alerts](/products/app-platform/how-to/create-alerts/) to monitor your Functions’ performance and trigger Function-level alerts.
