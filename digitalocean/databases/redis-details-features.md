---
source: https://docs.digitalocean.com/products/databases/redis/details/features/
scraped: 2025-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

                Caching Features | DigitalOcean Documentation
...
*   **Database metrics**. [Redis-specific performance metrics](/products/databases/redis/how-to/monitor-clusters/) help you assess the health of the database, pinpoint performance bottlenecks, and identify unusual use patterns that may indicate an application bug or security breach.
