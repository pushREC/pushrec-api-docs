---
source: https://docs.digitalocean.com/products/databases/mongodb/details/pricing/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               MongoDB Pricing | DigitalOcean Documentation
...
All managed databases are deployed onto Droplets with either [shared or dedicated CPU](/products/droplets/concepts/choosing-a-plan/#shared-vs-dedicated). For a list of the Droplet plans we offer for MongoDB, see the [Managed Databases pricing page](https://www.digitalocean.com/pricing/managed-databases#mongodb).
