---
source: https://docs.digitalocean.com/products/databases/mysql/how-to/add-read-only-nodes/
scraped: 2026-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

How to Add Read-Only Nodes to MySQL Database Clusters | DigitalOcean Documentation
...
Read-only nodes differ from [standby nodes](/products/databases/mysql/how-to/add-standby-nodes/), which are exact copies of the primary node that are automatically moved into place in the event of a primary node failure.
...
Like primary nodes, you can [limit access to a read-only nodes](/products/databases/mysql/how-to/secure/#firewalls) to trusted sources and access read-only nodes using a command-line client and the connection string in the node’s **Overview** page.
