---
source: https://docs.digitalocean.com/products/databases/opensearch/how-to/reconfigure/
scraped: 2026-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

How to Reconfigure OpenSearch Database Clusters | DigitalOcean Documentation
...
Validated on 17 Jun 2024 • Last edited on 10 Dec 2025

OpenSearch is an open-source search and analytics suite which serves as a centralized location to manage logs forwarded from other resources, such as databases and Droplets.

You can update your database engine’s parameters, such as `compression_type` and `group_min_session_timeout_ms`.

For a full list of the parameters you can edit, see the [control panel](#update-a-databases-configuration-using-the-control-panel) or [API reference](/reference/api/digitalocean/#operation/databases_patch_config), under the **REQUEST BODY SCHEMA** section, click **config**, and then click the **opensearch** option. To ensure database stability, you can only edit the parameters listed. To change other OpenSearch parameters, [contact support](https://cloudsupport.digitalocean.com).
