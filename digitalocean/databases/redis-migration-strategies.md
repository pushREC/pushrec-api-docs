---
source: https://docs.digitalocean.com/products/databases/redis/concepts/migration-strategies/
scraped: 2026-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

Migration Strategies | DigitalOcean Documentation
...
1.  Start [migrating your data](/products/databases/redis/how-to/migrate/) from the source database to the target database.
...
4.  Start [migrating your data](/products/databases/redis/how-to/migrate/) from the source database to the target database.
