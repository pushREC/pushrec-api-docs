---
source: https://docs.digitalocean.com/products/databases/mongodb/how-to/tag/
scraped: 2026-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

How to Tag MongoDB Database Clusters | DigitalOcean Documentation
...
Tags are custom labels you can apply to database clusters and other DigitalOcean resources. You can filter tagged databases clusters or [create monitoring alert policies](/products/databases/mongodb/how-to/set-up-alerts/) for multiple databases clusters with the same tag.
