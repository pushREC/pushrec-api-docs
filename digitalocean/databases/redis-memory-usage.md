---
source: https://docs.digitalocean.com/products/databases/redis/details/memory-usage/
scraped: 2026-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

Memory Usage for Caching Database Clusters | DigitalOcean Documentation
...
When you create a Caching database cluster, you [choose the cluster configuration](/products/databases/redis/how-to/create/#choose-a-cluster-configuration), including the size of the nodes. The node size determines how much memory and how many vCPUs the nodes have.

Plan Size

Available Memory (Adjusted)
