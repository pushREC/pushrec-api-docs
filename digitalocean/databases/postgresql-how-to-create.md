---
source: https://docs.digitalocean.com/products/databases/postgresql/how-to/create/
scraped: 2025-01-07
...
For the best performance, create your database in the same datacenter as your other DigitalOcean resources. After creation, you can [relocate your cluster to another datacenter](/products/databases/postgresql/how-to/relocate/).
...
After creation, you can [increase the number or size of database nodes](/products/databases/postgresql/how-to/resize/) at any time. However, you cannot downsize nodes to have less storage than the current storage the cluster is currently using.
...
You can [increase or decrease your storage](/products/databases/postgresql/how-to/resize/) at any time.
...
After creation, you can always [edit the database’s tags](/products/databases/postgresql/how-to/tag/) or move it to another project; however, its name cannot be changed.

When you’re ready, click the **Create a Database Cluster** button.

Clusters typically take five minutes or more to provision, but you can complete important configuration tasks such as [restricting inbound connections](/products/databases/postgresql/how-to/secure/#firewalls) while you wait.
