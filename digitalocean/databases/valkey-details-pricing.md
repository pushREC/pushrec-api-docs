---
source: https://docs.digitalocean.com/products/databases/valkey/details/pricing/
scraped: 2025-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

                Valkey Pricing | DigitalOcean Documentation
...
All managed databases are deployed onto Droplets with either [shared or dedicated CPU](/products/droplets/concepts/choosing-a-plan/#shared-vs-dedicated). For a list of the Droplet plans we offer for Valkey, see the [Managed Databases pricing page](https://www.digitalocean.com/pricing/managed-databases).
