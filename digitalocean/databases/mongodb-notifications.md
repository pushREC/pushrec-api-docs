---
source: https://docs.digitalocean.com/products/databases/mongodb/details/notifications/
scraped: 2026-01-07
...
This page lists the database cluster issues we send email alerts for. You cannot disable or customize these automatic emails. To receive alerts about issues not covered here (like CPU usage), you can [set up cluster monitoring policies](/products/databases/mongodb/how-to/set-up-alerts/) based on specified parameters that you choose.
