---
source: https://docs.digitalocean.com/products/databases/kafka/how-to/manage-users-and-privileges/
scraped: 2026-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

How to Manage Kafka Users in a Database Cluster | DigitalOcean Documentation
...
By default, every database cluster is publicly accessible. To natively limit access, you can [add trusted sources](/products/databases/kafka/how-to/secure/#firewalls).
