---
source: https://docs.digitalocean.com/products/databases/mysql/how-to/create/
scraped: 2025-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

                How to Create MySQL Database Clusters | DigitalOcean Documentation
...
For the best performance, create your database in the same datacenter as your other DigitalOcean resources. After creation, you can [relocate your cluster to another datacenter](/products/databases/mysql/how-to/relocate/).
...
After creation, you can [increase the number or size of nodes](/products/databases/mysql/how-to/resize/) in the cluster at any time. However, you cannot downsize nodes to have less storage than the current storage the cluster is currently using.
...
You can [increase or decrease your storage](/products/databases/mysql/how-to/resize/) at any time.

### Enable storage autoscaling[](#enable-storage-autoscaling)

The **Autoscale storage** section lets you check a box to automatically increase storage when disk capacity reaches a set percentage threshold. The system bills this increase as [additional storage](/products/databases/mysql/details/pricing/). If you click **Customize**, you can type your own percentage threshold and storage increment.
...
After creation, you can always [edit the database’s tags](/products/databases/mysql/how-to/tag/) or move it to another project; however, its name cannot be changed.

When you’re ready, click the **Create a Database Cluster** button.

Clusters typically take five minutes or more to provision, but you can complete important configuration tasks such as [restricting inbound connections](/products/databases/mysql/how-to/secure/#firewalls) while you wait.
