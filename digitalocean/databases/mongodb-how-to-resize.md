---
source: https://docs.digitalocean.com/products/databases/mongodb/how-to/resize/
scraped: 2025-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

                How to Resize MongoDB Database Clusters | DigitalOcean Documentation
...
To switch to a database cluster plan with less storage, [fork the cluster](/products/databases/mongodb/how-to/fork-clusters/) and select a smaller database cluster plan for the new cluster.
