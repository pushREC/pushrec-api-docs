---
source: https://docs.digitalocean.com/products/databases/valkey/details/features/
scraped: 2025-01-07
tags: [digitalocean, databases, managed-db, api-docs]
---

Valkey Features | DigitalOcean Documentation
...
## Managed Database Cluster Features[](#managed-database-cluster-features)
...
## Valkey Features[](#valkey-features)

*   **Database metrics**. [Redis-specific performance metrics](/products/databases/valkey/how-to/monitor-clusters/) help you assess the health of the database, pinpoint performance bottlenecks, and identify unusual use patterns that may indicate an application bug or security breach.
