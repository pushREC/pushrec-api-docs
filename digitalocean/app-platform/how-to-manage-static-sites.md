---
source: https://docs.digitalocean.com/products/app-platform/how-to/manage-static-sites/
scraped: 2026-01-07
...
If a Static Site comprises the entirety of your App Platform app, you can use [the usual app creation process](/products/app-platform/getting-started/quickstart/#create-an-app). These instructions apply when a static site is only one resource that you’re adding to an existing app.

## Add a Static Site to an App Using Automation[](#add-a-static-site-to-an-app-using-automation)

You can add a static site to an app using the CLI’s app update command or the API’s app update endpoint. To add a static site, update the [app’s spec](/products/app-platform/reference/app-spec/) with the static site’s specifications and submit the spec using the following command or endpoint.
...
### cURL[](#add-a-static-site-to-an-app-curl)
...
### Python[](#add-a-static-site-to-an-app-python)
...
## Add a Static Site Using the Control Panel[](#add-a-static-site-using-the-control-panel)

In the [**Apps** section of the DigitalOcean Control Panel](https://cloud.digitalocean.com/apps), select your app. Click **Add components**, then choose **Create resources from source code** to add a Static Site.
...
## Configure a Static Site[](#configure-a-static-site)
...
## Destroy a Static Site[](#destroy-a-static-site)
