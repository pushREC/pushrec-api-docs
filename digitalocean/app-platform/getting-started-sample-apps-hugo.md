...
The Hugo buildpack applies to this sample app. See the [Hugo buildpack overview](/products/app-platform/reference/buildpacks/hugo/) for more information about its configuration options and limitations.
