...
3. **Create a new skill** - Build a custom skill for your workflow
4. **Learn about skills** - Understand how skills work in Claude Code

For example:
- To run a skill: `/skill-name` (like `/commit` or `/deep-research`)
- To create a skill: Use the `/skill-creator` skill or ask me to help you build one
