---
source: https://docs.digitalocean.com/reference/api/scopes/vpc_peering/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/vpc_peering/
domain: docs.digitalocean.com
---
                vpc\_peering | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [vpc\_peering](/reference/api/scopes/vpc_peering/)
            *   [vpc\_peering:create](/reference/api/scopes/vpc_peering/create/)
            *   [vpc\_peering:delete](/reference/api/scopes/vpc_peering/delete/)
            *   [vpc\_peering:read](/reference/api/scopes/vpc_peering/read/)
            *   [vpc\_peering:update](/reference/api/scopes/vpc_peering/update/)
...
[](/reference/api/scopes/vpc_peering/create/)
...
[](/reference/api/scopes/vpc_peering/delete/)
...
[](/reference/api/scopes/vpc_peering/read/)
...
[](/reference/api/scopes/vpc_peering/update/)
