---
source: https://docs.digitalocean.com/reference/api/scopes/spaces_key/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/spaces_key/
domain: docs.digitalocean.com
---
                spaces\_key | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [spaces\_key](/reference/api/scopes/spaces_key/)
            *   [spaces\_key:create\_credentials](/reference/api/scopes/spaces_key/create_credentials/)
            *   [spaces\_key:delete](/reference/api/scopes/spaces_key/delete/)
            *   [spaces\_key:read](/reference/api/scopes/spaces_key/read/)
            *   [spaces\_key:update](/reference/api/scopes/spaces_key/update/)
            *   [spaces\_keys:create](/reference/api/scopes/spaces_key/create/)
...
[](/reference/api/scopes/spaces_key/create/)
...
[](/reference/api/scopes/spaces_key/create_credentials/)
...
[](/reference/api/scopes/spaces_key/delete/)
...
[](/reference/api/scopes/spaces_key/read/)
...
[](/reference/api/scopes/spaces_key/update/)
