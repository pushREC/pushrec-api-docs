---
source: https://docs.digitalocean.com/reference/api/scopes/kubernetes/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/kubernetes/
domain: docs.digitalocean.com
---
                kubernetes | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [kubernetes](/reference/api/scopes/kubernetes/)
            *   [kubernetes:access\_cluster](/reference/api/scopes/kubernetes/access_cluster/)
            *   [kubernetes:create](/reference/api/scopes/kubernetes/create/)
            *   [kubernetes:delete](/reference/api/scopes/kubernetes/delete/)
            *   [kubernetes:read](/reference/api/scopes/kubernetes/read/)
            *   [kubernetes:update](/reference/api/scopes/kubernetes/update/)
...
[](/reference/api/scopes/kubernetes/access_cluster/)
...
[](/reference/api/scopes/kubernetes/create/)
...
[](/reference/api/scopes/kubernetes/delete/)
...
[](/reference/api/scopes/kubernetes/read/)
...
[](/reference/api/scopes/kubernetes/update/)
