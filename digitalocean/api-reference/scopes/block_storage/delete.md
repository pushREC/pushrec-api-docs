---
source: https://docs.digitalocean.com/reference/api/scopes/block_storage/delete/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/block_storage/delete/
domain: docs.digitalocean.com
---
                block\_storage:delete | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [block\_storage](/reference/api/scopes/block_storage/)
            *   [block\_storage:create](/reference/api/scopes/block_storage/create/)
            *   [block\_storage:delete](/reference/api/scopes/block_storage/delete/)
            *   [block\_storage:read](/reference/api/scopes/block_storage/read/)
