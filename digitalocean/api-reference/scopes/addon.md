---
source: https://docs.digitalocean.com/reference/api/scopes/addon/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/addon/
domain: docs.digitalocean.com
---
                addon | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [addon](/reference/api/scopes/addon/)
            *   [addon:create](/reference/api/scopes/addon/create/)
            *   [addon:delete](/reference/api/scopes/addon/delete/)
            *   [addon:read](/reference/api/scopes/addon/read/)
            *   [addon:update](/reference/api/scopes/addon/update/)
...
[](/reference/api/scopes/addon/create/)
...
[](/reference/api/scopes/addon/delete/)
...
[](/reference/api/scopes/addon/read/)
...
[](/reference/api/scopes/addon/update/)
