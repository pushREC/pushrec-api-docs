---
source: https://docs.digitalocean.com/reference/api/scopes/reserved_ip/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/reserved_ip/
domain: docs.digitalocean.com
---
                reserved\_ip | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [reserved\_ip](/reference/api/scopes/reserved_ip/)
            *   [reserved\_ip:create](/reference/api/scopes/reserved_ip/create/)
            *   [reserved\_ip:delete](/reference/api/scopes/reserved_ip/delete/)
            *   [reserved\_ip:read](/reference/api/scopes/reserved_ip/read/)
            *   [reserved\_ip:update](/reference/api/scopes/reserved_ip/update/)
...
[](/reference/api/scopes/reserved_ip/create/)
...
[](/reference/api/scopes/reserved_ip/delete/)
...
[](/reference/api/scopes/reserved_ip/read/)
...
[](/reference/api/scopes/reserved_ip/update/)
