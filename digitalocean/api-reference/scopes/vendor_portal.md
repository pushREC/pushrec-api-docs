---
source: https://docs.digitalocean.com/reference/api/scopes/vendor_portal/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/vendor_portal/
domain: docs.digitalocean.com
---
                vendor\_portal | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [vendor\_portal](/reference/api/scopes/vendor_portal/)
            *   [vendor\_portal:create](/reference/api/scopes/vendor_portal/create/)
            *   [vendor\_portal:delete](/reference/api/scopes/vendor_portal/delete/)
            *   [vendor\_portal:read](/reference/api/scopes/vendor_portal/read/)
            *   [vendor\_portal:update](/reference/api/scopes/vendor_portal/update/)
...
[](/reference/api/scopes/vendor_portal/create/)
...
[](/reference/api/scopes/vendor_portal/delete/)
...
[](/reference/api/scopes/vendor_portal/read/)
...
[](/reference/api/scopes/vendor_portal/update/)
