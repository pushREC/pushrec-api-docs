---
source: https://docs.digitalocean.com/reference/api/scopes/monitoring/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/monitoring/
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [monitoring](/reference/api/scopes/monitoring/)
            *   [monitoring:create](/reference/api/scopes/monitoring/create/)
            *   [monitoring:delete](/reference/api/scopes/monitoring/delete/)
            *   [monitoring:read](/reference/api/scopes/monitoring/read/)
            *   [monitoring:update](/reference/api/scopes/monitoring/update/)
...
[](/reference/api/scopes/monitoring/create/)
...
[](/reference/api/scopes/monitoring/delete/)
...
[](/reference/api/scopes/monitoring/read/)
...
[](/reference/api/scopes/monitoring/update/)
