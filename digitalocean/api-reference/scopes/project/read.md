---
source: https://docs.digitalocean.com/reference/api/scopes/project/read/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/project/read/
domain: docs.digitalocean.com
---
                project:read | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [project](/reference/api/scopes/project/)
            *   [project:create](/reference/api/scopes/project/create/)
            *   [project:delete](/reference/api/scopes/project/delete/)
            *   [project:read](/reference/api/scopes/project/read/)
            *   [project:update](/reference/api/scopes/project/update/)
