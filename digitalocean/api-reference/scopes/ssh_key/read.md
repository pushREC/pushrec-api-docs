---
source: https://docs.digitalocean.com/reference/api/scopes/ssh_key/read/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/ssh_key/read/
domain: docs.digitalocean.com
---
                ssh\_key:read | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [ssh\_key](/reference/api/scopes/ssh_key/)
            *   [ssh\_key:create](/reference/api/scopes/ssh_key/create/)
            *   [ssh\_key:delete](/reference/api/scopes/ssh_key/delete/)
            *   [ssh\_key:read](/reference/api/scopes/ssh_key/read/)
            *   [ssh\_key:update](/reference/api/scopes/ssh_key/update/)
...
`ssh_key:read` has no additional required scopes.
...
The following scopes are associated with `ssh_key:read`:
