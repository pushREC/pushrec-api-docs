---
source: https://docs.digitalocean.com/reference/api/scopes/uptime/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/uptime/
domain: docs.digitalocean.com
---
                uptime | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [uptime](/reference/api/scopes/uptime/)
            *   [uptime:create](/reference/api/scopes/uptime/create/)
            *   [uptime:delete](/reference/api/scopes/uptime/delete/)
            *   [uptime:read](/reference/api/scopes/uptime/read/)
            *   [uptime:update](/reference/api/scopes/uptime/update/)
...
[](/reference/api/scopes/uptime/create/)
...
[](/reference/api/scopes/uptime/delete/)
...
[](/reference/api/scopes/uptime/read/)
...
[](/reference/api/scopes/uptime/update/)
