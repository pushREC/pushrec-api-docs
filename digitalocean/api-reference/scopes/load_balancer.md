---
source: https://docs.digitalocean.com/reference/api/scopes/load_balancer/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/load_balancer/
domain: docs.digitalocean.com
---
                load\_balancer | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [load\_balancer](/reference/api/scopes/load_balancer/)
            *   [load\_balancer:create](/reference/api/scopes/load_balancer/create/)
            *   [load\_balancer:delete](/reference/api/scopes/load_balancer/delete/)
            *   [load\_balancer:read](/reference/api/scopes/load_balancer/read/)
            *   [load\_balancer:update](/reference/api/scopes/load_balancer/update/)
...
[](/reference/api/scopes/load_balancer/create/)
...
[](/reference/api/scopes/load_balancer/delete/)
...
[](/reference/api/scopes/load_balancer/read/)
...
[](/reference/api/scopes/load_balancer/update/)
