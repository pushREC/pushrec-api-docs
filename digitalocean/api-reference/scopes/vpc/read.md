---
source: https://docs.digitalocean.com/reference/api/scopes/vpc/read/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/vpc/read/
domain: docs.digitalocean.com
---
                vpc:read | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [vpc](/reference/api/scopes/vpc/)
            *   [vpc:create](/reference/api/scopes/vpc/create/)
            *   [vpc:delete](/reference/api/scopes/vpc/delete/)
            *   [vpc:read](/reference/api/scopes/vpc/read/)
            *   [vpc:update](/reference/api/scopes/vpc/update/)
