---
source: https://docs.digitalocean.com/reference/api/scopes/genai/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/genai/
domain: docs.digitalocean.com
---
                genai | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [genai](/reference/api/scopes/genai/)
            *   [genai:create](/reference/api/scopes/genai/create/)
            *   [genai:delete](/reference/api/scopes/genai/delete/)
            *   [genai:read](/reference/api/scopes/genai/read/)
            *   [genai:update](/reference/api/scopes/genai/update/)
...
[](/reference/api/scopes/genai/create/)
...
[](/reference/api/scopes/genai/delete/)
...
[](/reference/api/scopes/genai/read/)
...
[](/reference/api/scopes/genai/update/)
