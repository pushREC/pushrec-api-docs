---
source: https://docs.digitalocean.com/reference/api/scopes/image/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/image/
domain: docs.digitalocean.com
---
                image | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [image](/reference/api/scopes/image/)
            *   [image:create](/reference/api/scopes/image/create/)
            *   [image:delete](/reference/api/scopes/image/delete/)
            *   [image:read](/reference/api/scopes/image/read/)
            *   [image:update](/reference/api/scopes/image/update/)
...
[](/reference/api/scopes/image/create/)
...
[](/reference/api/scopes/image/delete/)
...
[](/reference/api/scopes/image/read/)
...
[](/reference/api/scopes/image/update/)
