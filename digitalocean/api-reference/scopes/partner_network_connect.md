---
source: https://docs.digitalocean.com/reference/api/scopes/partner_network_connect/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/partner_network_connect/
domain: docs.digitalocean.com
---
                partner\_network\_connect | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [partner\_network\_connect](/reference/api/scopes/partner_network_connect/)
            *   [partner\_network\_connect:create](/reference/api/scopes/partner_network_connect/create/)
            *   [partner\_network\_connect:delete](/reference/api/scopes/partner_network_connect/delete/)
            *   [partner\_network\_connect:read](/reference/api/scopes/partner_network_connect/read/)
            *   [partner\_network\_connect:update](/reference/api/scopes/partner_network_connect/update/)
            *   [partner\_network\_connect:view\_credentials](/reference/api/scopes/partner_network_connect/view_credentials/)
...
[](/reference/api/scopes/partner_network_connect/create/)
...
[](/reference/api/scopes/partner_network_connect/delete/)
...
[](/reference/api/scopes/partner_network_connect/read/)
...
[](/reference/api/scopes/partner_network_connect/update/)
...
[](/reference/api/scopes/partner_network_connect/view_credentials/)
