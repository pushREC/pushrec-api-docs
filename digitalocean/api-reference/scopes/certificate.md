---
source: https://docs.digitalocean.com/reference/api/scopes/certificate/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/certificate/
domain: docs.digitalocean.com
---
                certificate | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [certificate](/reference/api/scopes/certificate/)
            *   [certificate:create](/reference/api/scopes/certificate/create/)
            *   [certificate:delete](/reference/api/scopes/certificate/delete/)
            *   [certificate:read](/reference/api/scopes/certificate/read/)
...
[](/reference/api/scopes/certificate/create/)
...
[](/reference/api/scopes/certificate/delete/)
...
[](/reference/api/scopes/certificate/read/)
