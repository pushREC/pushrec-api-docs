---
source: https://docs.digitalocean.com/reference/api/scopes/snapshot/delete/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/snapshot/delete/
domain: docs.digitalocean.com
---
                snapshot:delete | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [snapshot](/reference/api/scopes/snapshot/)
            *   [snapshot:delete](/reference/api/scopes/snapshot/delete/)
            *   [snapshot:read](/reference/api/scopes/snapshot/read/)
