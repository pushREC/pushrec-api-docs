---
source: https://docs.digitalocean.com/reference/api/scopes/droplet/
scraped: 2026-01-07
...
source_url: https://docs.digitalocean.com/reference/api/scopes/droplet/
domain: docs.digitalocean.com
---
                droplet | DigitalOcean Documentation
...
*   [![](/images/icons/api.47c17d0d57a6ef27c2bdc744b3a7b71edc80838dfbe8431e12f5c3e81f371510.svg)APIs](/reference/api/)
    ...
    *   [Token Scopes](/reference/api/scopes/)
        ...
        *   [droplet](/reference/api/scopes/droplet/)
            *   [droplet:admin](/reference/api/scopes/droplet/admin/)
            *   [droplet:create](/reference/api/scopes/droplet/create/)
            *   [droplet:delete](/reference/api/scopes/droplet/delete/)
            *   [droplet:read](/reference/api/scopes/droplet/read/)
            *   [droplet:update](/reference/api/scopes/droplet/update/)
...
[](/reference/api/scopes/droplet/admin/)
...
[](/reference/api/scopes/droplet/create/)
...
[](/reference/api/scopes/droplet/delete/)
...
[](/reference/api/scopes/droplet/read/)
...
[](/reference/api/scopes/droplet/update/)
