...
source_url: https://docs.digitalocean.com/products/networking/dns/how-to/download-zone-file/
domain: docs.digitalocean.com
---
                How to Download DNS Zone Files | DigitalOcean Documentation
...
# How to Download DNS Zone Files
...
DNS zone files are plain text files that contain all of the record information for your domain on DigitalOcean. You can download this file to migrate DNS configurations to [other DigitalOcean Teams](/platform/teams/) or DNS providers.

To download a zone file for a domain, log in to the [control panel](https://cloud.digitalocean.com) and click **Networking** in the main menu, then go to the **Domains** tab.
...
On the right, open the **More** menu of the domain whose zone file you want to download, and then click **Download zone**. The zone file downloads to your local machine.

In this article...

[How to Download DNS Zone Files](https://docs.digitalocean.com/products/networking/dns/how-to/download-zone-file/)
