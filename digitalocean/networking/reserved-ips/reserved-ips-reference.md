...
source_url: https://docs.digitalocean.com/products/networking/reserved-ips/reference/
domain: docs.digitalocean.com
---
                Reserved IP Reference | DigitalOcean Documentation
...
You can use the API to [create, list, and delete reserved IP addresses](/reference/api/digitalocean/#tag/Reserved-IPs). You can also [manage specific reserved IP addresses using the API](/reference/api/digitalocean/#tag/Reserved-IP-Actions), such as assigning or unassigning them.
...
[`doctl`](https://github.com/digitalocean/doctl) supports managing reserved IP addresses from the command line. See the [`doctl` documentation](/reference/doctl/reference/compute/reserved-ip/) or use `doctl compute reserved-ip --help` for more information.
...
[Reserved IP Reference](https://docs.digitalocean.com/products/networking/reserved-ips/reference/)
