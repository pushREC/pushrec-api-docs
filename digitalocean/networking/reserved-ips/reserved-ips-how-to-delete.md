...
source_url: https://docs.digitalocean.com/products/networking/reserved-ips/how-to/delete/
domain: docs.digitalocean.com
---
                How to Delete Reserved IPs | DigitalOcean Documentation
...
## Delete an Assigned IP Using Automation[](#delete-an-assigned-ip-using-automation)
...
### cURL[](#delete-a-reserved-ipv4-curl)
...
### Ruby[](#delete-a-reserved-ipv4-ruby)
...
### Python[](#delete-a-reserved-ipv4-python)
...
## Delete an Assigned IP Using the Control Panel[](#delete-an-assigned-ip-using-the-control-panel)
