...
source_url: https://docs.digitalocean.com/products/networking/reserved-ips/how-to/deprovision-byoip/
domain: docs.digitalocean.com
---
                How to Deprovision a BYOIP Prefix | DigitalOcean Documentation
...
You can deprovision Bring Your Own IP (BYOIP) prefixes with [`doctl`](/reference/doctl/), the [DigitalOcean API](/reference/api/#digitalocean), or the control panel.
...
## Deprovision a BYOIP Prefix Using the CLI[](#deprovision-a-byoip-prefix-using-the-cli)
...
## Deprovision a BYOIP Prefix Using the API[](#deprovision-a-byoip-prefix-using-the-api)
...
## Deprovision a BYOIP Prefix Using the Control Panel[](#deprovision-a-byoip-prefix-using-the-control-panel)
