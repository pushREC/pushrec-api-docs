...
source_url: https://docs.digitalocean.com/products/networking/firewalls/how-to/
domain: docs.digitalocean.com
---
                Firewalls How-Tos | DigitalOcean Documentation
...
## Cloud Firewall Management[](#cloud-firewall-management)

[](/products/networking/firewalls/how-to/view-rules-for-droplet/)

![](https://docs.digitalocean.com/images/icons/firewalls.svg)

How to View All Firewall Rules Applied to a Droplet

View the full set of firewall rules applied to a Droplet from all cloud firewalls.

[](/products/networking/firewalls/how-to/destroy/)

![](https://docs.digitalocean.com/images/icons/firewalls.svg)

How to Destroy Firewalls

Destroy a firewall to remove it permanently from your account. Destroying a firewall does not destroy the Droplets that were associated with it.

In this article...

[Firewalls How-Tos](https://docs.digitalocean.com/products/networking/firewalls/how-to/)
