...
*   [A DigitalOcean Load Balancer](/products/networking/load-balancers/how-to/create/) with those Droplets added to its backend.
    

To configure the load balancer to balance TCP, you need to add a TCP forwarding rule and a TCP health check.

## Add the TCP Forwarding Rule[](#add-the-tcp-forwarding-rule)
...
## Add the TCP Health Check[](#add-the-tcp-health-check)
