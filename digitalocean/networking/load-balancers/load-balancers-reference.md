...
source_url: https://docs.digitalocean.com/products/networking/load-balancers/reference/
domain: docs.digitalocean.com
---
                Load Balancer Reference | DigitalOcean Documentation
...
You can use the API to [create, delete, and manage load balancers](/reference/api/digitalocean/#tag/Load-Balancers).
...
[`doctl`](https://github.com/digitalocean/doctl) supports managing load balancers from the command line. See the [`doctl` documentation](/reference/doctl/reference/compute/load-balancer/) or use `doctl compute load-balancer --help` for more information.
...
[Load Balancer Reference](https://docs.digitalocean.com/products/networking/load-balancers/reference/)
