...
source_url: https://docs.digitalocean.com/products/networking/ipv6/reference/
domain: docs.digitalocean.com
---
                IPv6 Reference | DigitalOcean Documentation
...
[`doctl`](https://github.com/digitalocean/doctl) supports enabling IPv6 addresses from the command line. See the [`doctl` documentation](/reference/doctl/reference/compute/droplet-action/enable-ipv6/) or use `doctl compute droplet-action enable-ipv6 --help` for more information.
...
[](https://docs.digitalocean.com/reference/api/digitalocean/#operation/dropletActions_post)
...
[](/reference/doctl/reference/compute/droplet-action/enable-ipv6/)
