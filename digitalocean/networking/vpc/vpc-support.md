...
source_url: https://docs.digitalocean.com/products/networking/vpc/support/
domain: docs.digitalocean.com
---
                VPC Support | DigitalOcean Documentation
...
[](/support/can-i-add-an-old-droplet-to-a-vpc-without-changing-its-ip-address/)
