...
source_url: https://docs.digitalocean.com/products/networking/vpc/how-to/destroy/
domain: docs.digitalocean.com
---
                How to Destroy a VPC | DigitalOcean Documentation
...
You can only destroy a VPC network that has no resources in it. You can either destroy the resources or safely [migrate Droplets, volumes, and databases](/products/networking/vpc/how-to/migrate-resources/) out of a VPC network first.

## Delete a VPC Network Using Automation[](#delete-a-vpc-network-using-automation)
...
### cURL[](#delete-a-vpc-network-curl)
...
### Python[](#delete-a-vpc-network-python)
...
## Delete a VPC Network Using the Control Panel[](#delete-a-vpc-network-using-the-control-panel)
