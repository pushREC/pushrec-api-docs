---
source: https://docs.digitalocean.com/products/bare-metal-gpus/support/contact/
scraped: 2026-01-07
tags: [digitalocean, compute, droplets, api-docs]
---

Contact Support for DigitalOcean Gradient™ AI Bare Metal GPUs | DigitalOcean Documentation
...
For help with bare metal GPUs, [contact DigitalOcean Support](https://cloudsupport.digitalocean.com/), or submit the form below.

  

In this article...

[Contact Support for DigitalOcean Gradient™ AI Bare Metal GPUs](https://docs.digitalocean.com/products/bare-metal-gpus/support/contact/)
