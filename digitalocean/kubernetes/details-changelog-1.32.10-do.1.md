---
source: https://docs.digitalocean.com/products/kubernetes/details/changelog/1.32.10-do.1/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               1.32.10-do.1 | DigitalOcean Documentation
...
*   [Details](/products/kubernetes/details/)
    ...
    *   [Changelog](/products/kubernetes/details/changelog/)
        *   [1.32.10-do.1](/products/kubernetes/details/changelog/1.32.10-do.1/)
...
[1.32.10-do.1](https://docs.digitalocean.com/products/kubernetes/details/changelog/1.32.10-do.1/)
