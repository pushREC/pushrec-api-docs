---
source: https://docs.digitalocean.com/products/kubernetes/how-to/create-snapshots/
scraped: 2025-01-07
api_provider: DigitalOcean
discovery_tier: 3
verified: false
---
               How to Create Volume Snapshots in Kubernetes Clusters | DigitalOcean Documentation
...
Validated on 20 Aug 2019 • Last edited on 20 Oct 2025
...
You can now observe the state of your volumes and snapshots in the [DigitalOcean Control Panel](https://cloud.digitalocean.com) or by using the following command:

    kubectl get pvc && kubectl get pv && kubectl get volumesnapshot

## More Information[](#more-information)

*   To import volumes from existing snapshots, see [How to Restore Volumes from Snapshots in Kubernetes Clusters](/products/kubernetes/how-to/restore-volumes/).
*   For more details and examples of using snapshots in Kubernetes, see [the official Kubernetes blog announcement](https://kubernetes.io/blog/2018/10/09/introducing-volume-snapshot-alpha-for-kubernetes/).
