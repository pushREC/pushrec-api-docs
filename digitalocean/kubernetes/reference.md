---
source: https://docs.digitalocean.com/products/kubernetes/reference/
scraped: 2025-01-07
tags: [digitalocean, kubernetes, doks, api-docs]
---

                Kubernetes Reference | DigitalOcean Documentation
...
You can use the API to [create, delete, and manage Kubernetes clusters](/reference/api/digitalocean/#tag/Kubernetes).
...
[`doctl`](https://github.com/digitalocean/doctl) supports managing Kubernetes clusters from the command line. See the [`doctl` documentation](/reference/doctl/reference/kubernetes/) or use `doctl kubernetes --help` for more information.

## The DigitalOcean MCP Server[](#the-digitalocean-mcp-server)

The [DigitalOcean MCP server](/reference/mcp/) lets you use natural language prompts to manage Kubernetes clusters and node-pools through structured, argument-based inputs. They do not require resource URIs, and they support pagination and filtering when those features are available.
