---
source: https://docs.digitalocean.com/products/kubernetes/details/changelog/unavailable/1.22.7-do.0/
scraped: 2025-01-07
tags: [digitalocean, kubernetes, doks, api-docs]
---

                1.22.7-do.0 | DigitalOcean Documentation
...
*   [Details](/products/kubernetes/details/)
    ...
    *   [Changelog](/products/kubernetes/details/changelog/)
        *   [1.22.7-do.0](/products/kubernetes/details/changelog/unavailable/1.22.7-do.0/)
...
[1.22.7-do.0](https://docs.digitalocean.com/products/kubernetes/details/changelog/unavailable/1.22.7-do.0/)
