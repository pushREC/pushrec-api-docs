---
source: https://docs.digitalocean.com/products/kubernetes/details/changelog/1.34.1.do-2/
scraped: 2025-01-07
tags: [digitalocean, kubernetes, doks, api-docs]
---

                1.34.1-do.2 | DigitalOcean Documentation
...
*   [Details](/products/kubernetes/details/)
    ...
    *   [Changelog](/products/kubernetes/details/changelog/)
        *   [1.34.1-do.2](/products/kubernetes/details/changelog/1.34.1.do-2/)
...
[1.34.1-do.2](https://docs.digitalocean.com/products/kubernetes/details/changelog/1.34.1.do-2/)
