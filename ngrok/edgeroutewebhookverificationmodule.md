---
created: 2026-01-09
tags: [type/api-reference, api/edgeroutewebhookverificationmodule]
api_name: ngrok OpenAPI
category: EdgeRouteWebhookVerificationModule
endpoint_count: 3
---

# ngrok OpenAPI - Edgeroutewebhookverificationmodule
...
curl -X PUT \
  ...
  "https://api.ngrok.com/edges/https/{edge_id}/routes/{id}/webhook_verification"
```
