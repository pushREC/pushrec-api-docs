---
created: 2026-01-09
tags: [type/api-reference, api/snippets]
...
|------|-----|------|----------|-------------|
| `role` | query | string | No | Filter down the result based on the authenticated  |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `_body` | body | string | Yes | The new snippet object. |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `_body` | body | string | Yes | The contents of the new comment. |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `_body` | body | string | Yes | The contents to update the comment to. |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `path` | query | string | No | When used, only one the diff of the specified file |
