---
created: 2026-01-09
tags: [type/api-reference, api/source]
...
|------|-----|------|----------|-------------|
| `renames` | query | string | No | 
When `true`, Bitbucket will follow the history of |
| `q` | query | string | No | 
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `format` | query | string | No | Instead of returning the file's contents, return t |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `message` | query | string | No | The commit message. When omitted, Bitbucket uses a |
| `author` | query | string | No | 
The raw string to be used as the new commit's aut |
| `parents` | query | string | No | 
#### Deprecation Notice:
Support for specifying m |
| `files` | query | string | No | 
Optional field that declares the files that the r |
| `branch` | query | string | No | 
The name of the branch that the new commit should |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `format` | query | string | No | If 'meta' is provided, returns the (json) meta dat |
| `q` | query | string | No | Optional filter expression as per [filtering and s |
| `sort` | query | string | No | Optional sorting parameter as per [filtering and s |
| `max_depth` | query | string | No | If provided, returns the contents of the repositor |
