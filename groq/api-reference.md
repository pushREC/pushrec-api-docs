...
[Responses (beta)](api-reference#responses)

[Create response](api-reference#responses-create)
...
[Cancel batch](api-reference#batches-cancel)
...
[Fine Tuning](api-reference#fine-tuning)

[List fine tunings](api-reference#fine-tuning-list)

[Create fine tuning](api-reference#fine-tuning-create)

[Get fine tuning](api-reference#fine-tuning-get)

[Delete fine tuning](api-reference#fine-tuning-delete)
...
](api-reference#responses-create-request-body)
...
](api-reference#responses-create-returns)
...
](api-reference#fine-tuning-list)
...
](api-reference#fine-tuning-list-returns)
...
](api-reference#fine-tuning-create-request-body)
...
](api-reference#fine-tuning-create-returns)
...
](api-reference#fine-tuning-get-returns)
...
](api-reference#fine-tuning-delete)
...
](api-reference#fine-tuning-delete-returns)
