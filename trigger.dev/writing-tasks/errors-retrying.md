...
- In your [trigger.config file](/docs/config/config-file) you can set the default retrying behavior for all tasks.
...
## 
[​
](#a-simple-example-with-openai)A simple example with OpenAI
...
## 
[​
](#retrying-smaller-parts-of-a-task)Retrying smaller parts of a task
...
## 
[​
](#advanced-error-handling-and-retrying)Advanced error handling and retrying
...
### 
[​
](#openai-error-handling-example)OpenAI error handling example
...
### 
[​
](#using-aborttaskrunerror)Using `AbortTaskRunError`
...
[Suggest edits](https://github.com/triggerdotdev/trigger.dev/edit/main/docs/errors-retrying.mdx)[Raise issue](https://github.com/triggerdotdev/trigger.dev/issues/new?title=Issue on docs&body=Path: /errors-retrying)

[Previous](/docs/logging)[OverviewDuring your run you can wait for a period of time or for something to happen.
...
- [Preventing retries](#preventing-retries)
- [Using AbortTaskRunError](#using-aborttaskrunerror)
- [Using try/catch](#using-try%2Fcatch)
