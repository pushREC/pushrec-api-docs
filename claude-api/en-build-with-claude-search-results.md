---
source: https://docs.anthropic.com/en/build-with-claude/search-results
scraped: 2026-01-07
...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fsearch-results)
...
Citation configuration with `enabled` boolean field

`cache_control`

object

Cache control settings (e.g., `{"type": "ephemeral"}`)
...
Ending position in the content arr
