...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Ftool-use%2Fprogrammatic-tool-calling)
...
Validate your tool's input\_schema

`tool_not_allowed`

Tool doesn't allow the requested caller type

Check `allowed_callers` includes the right contexts

`missing_beta_header`

PTC beta header not provided
...
*   [The allowed\_callers field](#the-allowed-callers-field)
