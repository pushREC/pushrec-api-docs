---
source: https://docs.anthropic.com/en/agents-and-tools/tool-use/code-execution-tool
scraped: 2026-01-07
...
duration_ms: 2625
---
ode execution tool - Claude Docs
...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Ftool-use%2Fcode-execution-tool)
...
Claude Haiku 3.5 (`claude-3-5-haiku-latest`) ([deprecated](/docs/en/about-claude/model-deprecations))
...
The `old_str` not found in file (for str\_replace)
...
`bash_code_execution_result`, `text_editor_code_execution_result`
...
*   [Using code execution with Agent Skills](#using-code-execution-with-agent-skill
