---
source: https://docs.anthropic.com/en/agents-and-tools/agent-skills/overview
scraped: 2026-01-07
...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Fagent-skills%2Foverview)
...
SKILL.md body with instructions and guidance
...
Bundled files executed via bash without loading contents into context
...
*   **Claude Code**:
    ...
    *   : Skills should only install packages locally in order to avoid interfering with the user's computer
