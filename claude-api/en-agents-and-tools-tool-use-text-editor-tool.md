...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Ftool-use%2Ftext-editor-tool)
...
Release of an updated text editor Tool that fixes some issues and adds an optional `max_characters` parameter. It is otherwise identical to `text_editor_20250429`.

April 29, 2025

`text_editor_20250429`

Release of the text editor Tool for Claude 4. This version removes the `undo_edit` command but maintains all other capabilities. The tool name has been updated to reflect its str\_replace-based architecture.
...
Initial release of the text editor Tool with Claude Sonnet 3.5 (). Provides capabilities for viewing, creating, and editing files through the , , , , and commands.
...
[retired](/docs/en/about-claude/model-deprecations)
...
Execute shell commands with Claud
