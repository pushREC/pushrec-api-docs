...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fbuild-with-claude%2Fextended-thinking)
...
*   [Thinking block preservation in Claude Opus 4.5](#thinking-block-preservation-in-claude-opus-4-5)
*   [Pricing](#pricing)
...
In rare cases where you need access to full thinking output for Claude 4 models, [contact our sales team](/cdn-cgi/l/email-protection#65160409001625040b110d170a150c064b060a08).
...
](/workbench/new?user=What+is+27+*+453%3F&thinking.budget_tokens=16000)
...
Supported with `interleaved-thinking-2025-05-14` beta header
...
**Preserved by default** (enables cache optimization, token savings)
...
](/docs/en/build-with-claude/prompt-engineering/extended-th
