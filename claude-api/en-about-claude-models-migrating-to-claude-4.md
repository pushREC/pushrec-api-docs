---
source: https://docs.anthropic.com/en/about-claude/models/migrating-to-claude-4
scraped: 2026-01-07
method: bright_data
duration_ms: 2786
---
...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fabout-claude%2Fmodels%2Fmigrating-to-claude-4)
...
*   [Sonnet 3.7 → 4.5 migration checklist](#sonnet-3-7-4-5-migration-checklist)
...
*   [Haiku 3.5 → 4.5 migration checklist](#haiku-3-5-4-5-migration-checklist)
*   [Choosing between Sonnet 4.5 and Haiku 4.5](#choosing-between-sonnet-4-5-and-haiku-4-5)
*   [Choose Claude Sonnet 4.5 (most intelligent) for:](#choose-claude-sonnet-4-5-most-intelligent-for)
*   [Choose Claude Haiku 4.5 (fastest and most intelligent Haiku) for:](#choose-claude-haiku-4-5-fastest-and-most-intelligent-haiku-for)
*   [Extended thinking recommendations](#extended-thinking-recommendations)
*   [Other migration scenarios](#other-migration-scenarios)
*   [Migrating from Claude Sonnet 4 → Sonnet 4.5](#migrating-from-claude-sonnet-4-sonnet-4-5)
*   [Migrating from Claude Opus 4.1 → Sonnet 4.5](#migrating-from-claude-opus-4-1-sonnet-4-5)
*   [Migrating from Claude Opus 4.1 → Opus 4.5](#migrating-from-claude-opus-4-1-opus-4-5)
*   [Migrating between Claude 4.5 models](#migrating-between-claude-4-5-models)
*   [Need help?](#need-help)
