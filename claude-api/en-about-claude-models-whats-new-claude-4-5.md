...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fabout-claude%2Fmodels%2Fwhats-new-claude-4-5)
...
*   [Key improvements in Opus 4.5 over Opus 4.1](#key-improvements-in-opus-4-5-over-opus-4-1)
*   [Maximum intelligence](#maximum-intelligence)
*   [Effort parameter](#effort-parameter)
*   [Computer use excellence](#computer-use-excellence)
*   [Practical performance](#practical-performance)
*   [Thinking block preservation](#thinking-block-preservation)
...
*   [Programmatic tool calling (Beta)](#programmatic-tool-calling-beta)
*   [Tool search tool (Beta)](#tool-search-tool-beta)
*   [Effort parameter (Beta)](#effort-parameter-beta)
*   [Tool use examples (Beta)](#tool-use-examples-beta)
...
](/docs/en/build-with-claude/prompt-engineering/claude-4-best-practices)[
...
](/docs/en/about-claude/models/migratin
