---
source: https://docs.anthropic.com/en/agents-and-tools/tool-use/bash-tool
scraped: 2026-01-07
method: bright_data
duration_ms: 2795
---
...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Ftool-use%2Fbash-tool)
...
Claude 4 models and Sonnet 3.7 ([deprecated](/docs/en/about-claude/model-deprecations))
...
View and edit text files with Clau
