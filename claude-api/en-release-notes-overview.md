...
duration_ms: 2578
---
laude Developer Platform - Claude Docs
...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Frelease-notes%2Foverview)
...
[Claude Developer Platform](/docs/en/release-notes/overview)
...
*   `computer_20250124`: Updated computer use tool with new command options including "hold\_key", "left\_mouse\_down", "left\_mouse\_up", "scroll", "triple\_click", and "wait". This tool requires the "computer-use-2025-01-24" anthropic-beta header. Learn more in our [tool use documentation](/docs/en/agents-and-tools/tool-use/ov
