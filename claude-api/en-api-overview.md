...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fapi%2Foverview)
...
[Claude on Amazon Bedrock](/docs/en/build-with-claude/claude-on-amazon-bedrock)

Vertex AI

Google Cloud

[Claude on Vertex AI](/docs/en/build-with-claude/claude-on-vertex-ai)

Azure AI

Microsoft Azure

[Claude on Azure AI](/docs/en/build-with-claude/claude-in-microsoft-foundry)
...
Standard endpoints (Messages, Token Counting)
