...
[Log in](/login?returnTo=%2Fdocs%2Fen%2Fabout-claude%2Fmodels%2Fchoosing-a-model)
...
Autonomous coding agents, cybersecurity automation, complex financial analysis, multi-hour research tasks, multi agent frameworks

Maximum intelligence with practical performance for complex specialized tasks

Claude Opus 4.5

Professional software engineering, advanced agents for office tasks, computer and browser use at scale, step-change vision applications

Exceptional intelligence and reasoning for specialized complex tasks

Claude Opus 4.1

Highly complex codebase refactoring, nuanced creative writing, specialized scientific analysis
...
](/docs/en/about-claude/models/whats-new-claude-4-5)[
